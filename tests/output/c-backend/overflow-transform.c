...
#line 1 "input/c-backend/overflow-transform.c"
void func(unsigned int arg1, unsigned int arg2)
{
#line 2 "input/c-backend/overflow-transform.c"
  if (4294967295U / arg2 < arg1)
  {
  }
}
