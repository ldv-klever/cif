...
#line 1 "input/c-backend/pretty-func.c"
void func(void)
{
  char const *var = ( char const *) & __PRETTY_FUNCTION__;
#line 3 "input/c-backend/pretty-func.c"
  char const __PRETTY_FUNCTION__[5U] = "func";
}
